...
/*   Updated: 2021/07/05 13:52:37 by lverdoes      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static inline void	huge_part_finish(t_vars *v)
{
	size_t	i;
	size_t	size;
...
static inline void	huge_part_11(t_vars *v)
{
	while (!group_x(v, &v->b))
	{
...
static inline void	huge_part_10(t_vars *v)
{
	while (!group_b(v, &v->a))
	{
...
static inline void	huge_part_9(t_vars *v)
{
	while (!group_x(v, &v->b))
	{
...
static inline void	huge_part_8(t_vars *v)
{
	while (!group_c(v, &v->b))
	{
...
static inline void	huge_part_7(t_vars *v)
{
	while (!group_a(v, &v->a))
	{
...
static inline void	huge_part_6(t_vars *v)
{
	while (!group_c(v, &v->b))
	{
...
static inline void	huge_part_5(t_vars *v)
{
	while (!group_b(v, &v->b))
	{
...
static inline void	huge_part_4(t_vars *v)
{
...
static inline void	huge_part_3(t_vars *v)
{
	while (!group_b(v, &v->b))
	{
...
static inline void	huge_part_x(t_vars *v)
{
	size_t	i;
	size_t	size;
...
static inline void	huge_part_xabc(t_vars *v)
{
	size_t	i;
	size_t	size;
